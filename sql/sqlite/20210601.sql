...
CREATE INDEX IF NOT EXISTS records_x_crdc_by_record on records_x_crdc(record_id);
CREATE INDEX IF NOT EXISTS records_x_crdc_by_crdc on records_x_crdc(crdc_id);
